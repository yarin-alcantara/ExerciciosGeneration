package com.gameshow.MinhaLojaDeGames.Controller;
...
import com.gameshow.MinhaLojaDeGames.repository.UsuarioRepository;
...
public class UsuarioController {
	...
	public ResponseEntity<List<UsuarioModel>> GetByTitulo(@PathVariable String nomeUsuario) {
